...
const ADDRESS_LINE = "38245, 38249 W 10 Mile Rd, Farmington Hills, MI 48335";
const GOOGLE_MAPS_URL = `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(ADDRESS_LINE)}`;
    ...
    <div class="top-bar">
      <div class="top-bar-inner">
        <div class="top-bar-left">
          <a class="top-bar-item top-bar-address-link" href="${GOOGLE_MAPS_URL}" target="_blank" rel="noopener noreferrer" aria-label="Open address in Google Maps"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewBox="0 0 16 16" aria-hidden="true"><path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"/></svg> ${ADDRESS_LINE}</a>
